...
class App extends Component {
  ...
  onSubmit = async event => {
    ...
    this.setState({ message: 'Wating on tranaction success...'});
    ...
    return (
      <div>
        ...
        <p>
          ...
          There are currently {this.state.players.length} players completing to win {web3.utils.fromWei(this.state.balance, 'ether')} ether! 
        </p>
